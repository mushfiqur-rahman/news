...
if(isset($_POST['submit']))
{
	...
	if($er == 0)
	{
		$sql = "update into pageFile(pageId, title, file) values( ".ms($page).", '".ms($title)."', '".ms($file['name'])."')";
...
<form method="post" action="" enctype="multipart/form-data">
    <div class="form-row justify-content-around">
        <div class="col-md-6 mb-5 ">
            ...
            <input type="text" name="title" class="form-control" id="tl" value="<?php print $title; ?>"/><?php print $etitle; ?><br><br>
